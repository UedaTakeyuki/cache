...
func NewIntCache(maxSize int) (*IntCache, error) {
	cache := IntCache{} // initialize
 ...
 * AddOrReplace
 */
func (cache IntCache) AddOrReplace(key int, entity interface{}) interface{} { // Add & Replace
 ...
 * Get
 */
func (cache IntCache) Get(key int) (result interface{}, isExist bool) {
 ...
 * Delete
 */
func (cache IntCache) Delete(key int) {
